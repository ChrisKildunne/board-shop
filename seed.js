...
(async function () {
  ...
  const products = await Product.create([
    ...
    { name: 'Boots', price: 300, description: 'Step into ultimate comfort and warmth with our Boots. These boots are designed to keep your feet cozy while providing excellent support for your snowboarding adventures. Make every ride an enjoyable experience.', img:'https://i.imgur.com/hFGduaA.png'},
    ...
    { name: 'Gloves', price: 50, description: "Keep your hands warm and protected with our versatile gloves. Designed for cold weather conditions, these gloves offer exceptional insulation and dexterity. Whether you're gripping your snowboard or building a snowman, your hands will stay cozy.", img:'https://i.imgur.com/VsELX8C.jpg' },
    { name: 'Helmet', price: 90, description: 'Safety first! Our reliable helmet is a must-have for any snowboarding enthusiast. Featuring advanced protection technology and a comfortable fit, this helmet keeps your head secure as you conquer the slopes.', img:'https://i.imgur.com/SsHd3MI.png' },
  ]);
